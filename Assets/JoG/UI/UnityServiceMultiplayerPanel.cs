...
namespace JoG.UI {
    ...
    public class UnityServiceMultiplayerPanel : MonoBehaviour {
        [Inject] internal SessionService _sessionManager;
        ...
        //        var result = await _sessionManager.CreateSessionAsync(_sessionNameInputField.text);
        //        if (result is "success") return;
        //        else Dialog.PopupConfirm("创建失败：" + result);
        ...
        //        CreateSessionButton.interactable = false;
        //        JoinSessionButton.interactable = false;
        //        var result = await _sessionManager.JoinSessionAsync(_sessionNameInputField.text);
        //        if (result is "success") return;
        //        else Dialog.PopupConfirm("加入失败：" + result);
        //        CreateSessionButton.interactable = true;
        //        JoinSessionButton.interactable = true;
        //    });
        //}
